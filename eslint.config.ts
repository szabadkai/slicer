...
export default tseslint.config(
  ...
  // Allow THREE.js imports in viewer-service and gpu-slicing
  {
    files: [
      ...
      'src/features/support-generation/pillar-store.ts',
      'src/features/hollow-drain/hollower.ts',
      'src/features/hollow-drain/splitter.ts',
      'src/features/surface-intent/intent-overlay.ts',
